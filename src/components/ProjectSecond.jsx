    ...
    >
      <div>
        ...
        <p className="mb-4 text-xl xs:text-lg">
          The project required me to test my skills in retrieving and posting
          data to an API, predominantly using JavaScript (JS) with some CSS
          involvement.
        </p>
        <ul className="flex flex-row justify-end gap-5">
          <li>
            <a
              target="_blank"
              className="optbutton"
              href="https://github.com/majkeloess/wordleGame"
            >
              GitHub repo
            </a>
          </li>
          <li>
            <a
              target="_blank"
              className="optbutton"
              href="https://majkeloess.github.io/wordleGame/"
            >
              Project page
            </a>
          </li>
