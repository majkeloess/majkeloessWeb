            ...
            <motion.div ref={ref}  className="box row-span-2"
                        ...
                        <div>
                              ...
                              <ul className="flex flex-col justify-center gap-5">
                                    <li>
                                    <a target="_blank" className="optbutton" href="https://github.com/majkeloess/calculator">
                                    GitHub repo
                                    </a>
                                    </li>
                                    <li>
                                    <a target="_blank" className="optbutton" href="https://majkeloess.github.io/calculator/">
                                    Project page
                                    </a>
                                    </li>
                              </ul>
