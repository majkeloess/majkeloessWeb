    ...
    >
      <div>
        ...
        <p className="mb-4 text-xl xs:text-lg">
          I created my own Command Line Interface (CLI) from scratch to monitor
          my daily mood. I aimed to improve my Node.js skills and experimented
          with internal modules(fs, http), yargs, asynchronous Node.js code, and
        ...
        <ul className="flex flex-row justify-end gap-5">
          <li>
            <a
              target="_blank"
              className="optbutton"
              href="https://github.com/majkeloess/moodChecker"
            >
              GitHub repo
            </a>
          </li>
